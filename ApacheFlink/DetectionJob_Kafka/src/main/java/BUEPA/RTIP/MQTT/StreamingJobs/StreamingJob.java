...
public class StreamingJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.put("kafkaBootStrapServer", "10.43.120.124:9092");
        conf.put("kafkaZookeeperConnect", "10.43.46.179:2181");
        conf.put("kafkaTopic", "usecase-input4");
        ...
        conf.put("telegramBotKey", "869277769:AAE7BREQKaEo1WjF56-Mu4FgSkPKwf-jDps");
        conf.put("telegramChannelID", "601736401");
        ...
        properties.setProperty("print.key", "false");
        ...
        final DataStream<Quintet<String, Double, String, Double, Double>> extractedDS = kafkaStream.map(
                new RichMapFunction<String, Quintet<String, Double, String, Double, Double>>() {
                    ...
                    public Quintet<String, Double, String, Double, Double> map(String s) throws Exception {
                        ...
                        String splittedInput = s.split("\\s{2,8}")[1];
                        String[] input = splittedInput.split(",");
